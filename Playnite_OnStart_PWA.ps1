# ----------------------------------------------------------
# A tracking script for browser games installed as a PWA.
# ----------------------------------------------------------

# Path of a browser (Chromium)
$BrowserPath = "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe"
# AppID of a PWA game. AppID can be found from the desktop shortcut.
...
function Start-PWAProcess {
    ...
    Start-Process -FilePath $FilePath -ArgumentList "--app-id=`"${ArgumentList}`""
